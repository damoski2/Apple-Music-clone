...
export const setGlobalSearchInput = (
  data: string,
...
export const setGlobalSearchResult = (
  data: any,
  dispatch: Dispatch<DispatchType>
) => {
  dispatch({
...
export const setGenrePlaylists = (
  data: any,
  dispatch: Dispatch<DispatchType>,
  genre: string,
  ...
  redirect && Router.push(`/browse/${genre}`);
};
...
export const setRecentlyPlayedTracks = (
  data: any,
  dispatch: Dispatch<DispatchType>
) => {
  dispatch({
...
export const setNewReleasesTracks = (
  data: any,
  dispatch: Dispatch<DispatchType>
) => {
  dispatch({
